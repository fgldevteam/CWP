...
oCMenu.wait=200 //How long to wait before hiding the menu on mouseout. Netscape 6 is a lot slower then Explorer, so to be sure that it works good enough there you should not have this lower then 500 - Value: milliseconds

//Background bar properties
oCMenu.usebar=0 //If you want to use a background-bar for the top items set this on - Value: 1 || 0
oCMenu.barcolor="#afafaf" //The color of the background bar - Value: "color"
oCMenu.barwidth="750" //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.pxbetween=20 //How much space you want between each of the top items. - Value: px || "%"
...
oCMenu.level[0].width=90 //The default width for each level[0] (top) items. You can override this on each item by spesifying the width when making the item. - Value: px || "%"
...
//oCMenu.level[0].bgcoloroff="#f9f9f9" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
//oCMenu.level[0].bgcoloron="#6699cc" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
oCMenu.level[0].style="padding:2px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8pt; font-weight:bold" //The style for all level[0] (top) items. - Value: "style_settings"
oCMenu.level[0].border=0 //The border size for all level[0] (top) items. - Value: px
oCMenu.level[0].bordercolor="#d9d9d9" //The border color for all level[0] (top) items. - Value: "color"
...
oCMenu.level[1].width=115
oCMenu.level[1].height=20
oCMenu.level[1].style="padding:2px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:7pt"
oCMenu.level[1].bgcoloroff="#ffffff" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[1].bgcoloron="gold" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
oCMenu.level[1].hovercolor="black" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[1].align="bottom"
oCMenu.level[1].offsetX=0
oCMenu.level[1].offsetY=0
oCMenu.level[1].border=1
oCMenu.level[1].bordercolor="#d9d9d9"
...
oCMenu.level[2].style="padding:2px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:8pt"
...
// menu arrows
cmTopMenuImage='&nbsp;&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/images/down_arrow.gif">'
cmSubMenuImage='&nbsp;&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/images/right_arrow.gif">'
...
cmTxtColor=''
cmHoverColor=''
cmDisBGColorOff='#efefef'
cmDisBGColorOn='#efefef'
cmDisHoverColor='#ccc'
cmDisTxtColor='#ccc'
