...
<html>
    <head>
    	<title><fmt:message key="form.inventoryadj.nonwarranty.title"/></title>
    </head>
    <body>
    <html:form action="/secure/forms/submitNonWarrantyAdj.do" method="POST">
        <!-- path to pdf xml template //-->
        <html:hidden property="xmlTemplateURL" value="/forms/nonWarrantyAdj.jsp"/>
        <input type="hidden" name="fileName" value="<fmt:message key='form.inventoryadj.nonwarranty.title'/>"/>
        <input type="hidden" name="subject" value="<fmt:message key='form.label.storenum'/>: <c:out value='${loginStore.number}'/> - <fmt:message key='form.inventoryadj.nonwarranty.title'/>"/>
        
        <table class="data pdfform">
            <caption style="background-color:#339933;"><fmt:message key="form.inventoryadj.nonwarranty.title"/></caption>
            <!-- HEADER //-->
            <tr>
            ...
            <tr><th style="background-color:#339933;" colspan="8"><fmt:message key="form.inventoryadj.header"/></th></tr>
            <tr>
                <th style="background-color:#339933;" colspan="2"><fmt:message key="form.label.upc"/></th>
                <th style="background-color:#339933;"><fmt:message key="form.label.quantity"/></th>
                <th style="background-color:#339933;"><fmt:message key="form.label.price"/></th>
                <th style="background-color:#339933;" colspan="4"><fmt:message key="form.label.description"/></th>
            </tr>
            ...
            <tr><td colspan="8" class="note"><fmt:message key="form.inventoryadj.nonwarranty.note"/></td></tr>                
			<tr>
